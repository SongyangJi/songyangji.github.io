import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{r as i,o as t,c as p,b as n,d as s,e as c,a as l}from"./app-_B3WXR86.js";const r={},o=l(`<h1 id="负载均衡的5种策略" tabindex="-1"><a class="header-anchor" href="#负载均衡的5种策略" aria-hidden="true">#</a> 负载均衡的5种策略</h1><p>要理解负载均衡，必须先搞清楚正向代理和反向代理。</p><p><strong>负载均衡的几种常用方式</strong></p><h2 id="_1、轮询-默认" tabindex="-1"><a class="header-anchor" href="#_1、轮询-默认" aria-hidden="true">#</a> 1、轮询（默认）</h2><p>每个请求按时间顺序逐一分配到不同的后端服务器，如果后端服务器down掉，能自动剔除。</p><div class="language-nginx line-numbers-mode" data-ext="nginx"><pre class="language-nginx"><code><span class="token directive"><span class="token keyword">upstream</span> backserver</span> <span class="token punctuation">{</span>
