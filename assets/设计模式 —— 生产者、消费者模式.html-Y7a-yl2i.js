import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,a as p}from"./app-DIpCpwqa.js";const t={},e=p(`<h1 id="使用-semaphore和循环数组" tabindex="-1"><a class="header-anchor" href="#使用-semaphore和循环数组" aria-hidden="true">#</a> 使用 Semaphore和循环数组</h1><ul><li><strong>使用信号量限制对有限资源的访问</strong></li><li><strong>使用二进制信号量实现锁</strong></li></ul><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">import</span> <span class="token import"><span class="token namespace">java<span class="token punctuation">.</span>util<span class="token punctuation">.</span>concurrent<span class="token punctuation">.</span></span><span class="token class-name">Semaphore</span></span><span class="token punctuation">;</span>
